// Generated by gencpp from file controller/Key.msg
// DO NOT EDIT!


#ifndef CONTROLLER_MESSAGE_KEY_H
#define CONTROLLER_MESSAGE_KEY_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::controller::Key_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::controller::Key_<ContainerAllocator> const> ConstPtr;

}; // struct Key_

typedef ::controller::Key_<std::allocator<void> > Key;

typedef boost::shared_ptr< ::controller::Key > KeyPtr;
typedef boost::shared_ptr< ::controller::Key const> KeyConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::controller::Key_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::controller::Key_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::controller::Key_<ContainerAllocator1> & lhs, const ::controller::Key_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::controller::Key_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::controller::Key_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::controller::Key_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::controller::Key_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::controller::Key_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::controller::Key_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::controller::Key_<ContainerAllocator> >
{
  ...
  static const char* value(const ::controller::Key_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5d57616b5631968bULL;
  static const uint64_t static_value2 = 0x8f1d31d23c83281fULL;
};

template<class ContainerAllocator>
struct DataType< ::controller::Key_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::controller::Key_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::controller::Key_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::controller::Key_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::controller::Key_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // CONTROLLER_MESSAGE_KEY_H
